          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                {count > 0 && (
                  <span className="rounded-full bg-knock-orange/10 px-1.5 py-0.5 text-[10px] font-bold text-knock-orange">
                    {count}
                  </span>
                )}
              </div>
                    ...
                    <div key={sub.id} className="py-1">
                      <label className="flex items-center gap-2.5">
                        <input
                          ...
                          disabled={disabled}
                          className="h-3.5 w-3.5 rounded border-gray-300 text-knock-orange accent-knock-orange"
                        />
                      ...
                      {isChecked && (
                        <input
                          ...
                          className="mt-1 ml-6 w-[calc(100%-24px)] rounded-md border border-gray-200 px-2.5 py-1 text-[11px] text-gray-700 placeholder:text-gray-400 focus:border-knock-blue focus:outline-none focus:ring-1 focus:ring-knock-blue"
                        />
                      )}
                    </div>
                  );
