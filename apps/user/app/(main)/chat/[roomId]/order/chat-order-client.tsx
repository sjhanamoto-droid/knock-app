...
export function ChatOrderClient({ initialSite, initialTemplates, initialPartnerName, roomId }: Props) {
  ...
  const [site] = useState<SiteData | null>(initialSite);
  const [templates] = useState<TemplateData>(initialTemplates);
