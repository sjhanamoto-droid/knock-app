...
export function ChatClient({ initialRooms, initialMyCompanyId }: { initialRooms: ChatRoom[]; initialMyCompanyId: string }) {
  const [menuOpen, setMenuOpen] = useState(false);
  const [viewMode, setViewMode] = useState<ViewMode>("select");
  const [rooms, setRooms] = useState<ChatRoom[]>(initialRooms);
  const [myCompanyId, setMyCompanyId] = useState(initialMyCompanyId);
