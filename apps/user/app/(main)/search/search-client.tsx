...
interface SearchClientProps {
  ...
  initialJobPins: JobPin[];
  initialContractorPins: ContractorPin[];
}

export function SearchClient({ initialContractors, initialMajors, initialJobPins, initialContractorPins }: SearchClientProps) {
  ...
  const [jobPins, setJobPins] = useState<JobPin[]>(initialJobPins);
  const [contractorPins, setContractorPins] = useState<ContractorPin[]>(initialContractorPins);
