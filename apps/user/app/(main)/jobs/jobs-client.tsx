...
export function JobsClient({ initialResult, initialOccupations }: { initialResult: JobSearchResult; initialOccupations: OccupationOption[] }) {
  ...
  const [occupations, setOccupations] = useState<OccupationOption[]>(initialOccupations);
