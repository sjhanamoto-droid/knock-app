...
export default function NewInvoicePage() {
  ...
  // 月をまたいでも選択を保持するため、IDのSetで管理
  const [selectedIds, setSelectedIds] = useState<Set<string>>(new Set());
  // 選択済みの納品書情報を保持（合計金額計算用）
  const [selectedNotes, setSelectedNotes] = useState<Map<string, DeliveryNote>>(new Map());
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] pb-40">
      ...
      <div className="sticky top-0 z-30 bg-white px-4 py-3 text-center shadow-sm">
        ...
        <h1 className="text-[16px] font-bold text-[#1A2340]">請求書を作成</h1>
