...
export function MemberDetailClient({ initialMember, memberId }: Props) {
  ...
  const [formData, setFormData] = useState({
    ...
    telNumber: initialMember?.telNumber ?? "",
    role: (initialMember?.role ?? "OTHER") as string,
    isActive: initialMember?.isActive ?? true,
  });
