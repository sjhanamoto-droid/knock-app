...
interface BottomNavProps {
  isOrderer: boolean;
  accentColor: string;
  initialChatBadge: boolean;
}

export function BottomNav({ isOrderer, accentColor, initialChatBadge }: BottomNavProps) {
  const pathname = usePathname();
  const [chatBadge, setChatBadge] = useState(initialChatBadge);
